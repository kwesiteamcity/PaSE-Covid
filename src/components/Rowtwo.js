...
import Pic1 from '../img1/img1.jpg'

import Pic3 from '../img1/img.jpg'
                                            ...
                                            <div className="col-md-4">
                                                    <div className="card text-center m-2">
                                                        <div className="card-body">
                                                            ...
                                                            <img  src={Pic1} alt="mee" className="img-fluid img-thumbnail"/>
                                                        </div> <br/>
                                                    </div>  
                                                    ...
                                                    <div className="card text-center m-2">
                                                        <div className="card-body">
                                                            ...
                                                            <p className="card-text">Covid-19 at the low <br/><img src={Pic3}alt=""/> </p>
                                                        </div>
                                                    </div>
